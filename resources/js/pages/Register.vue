            ...
            <div class="col-12 col-md-6 offset-md-3">
                <div class="card shadow sm">
                    <div class="card-body">
                        ...
                        <h3 class="text-center">Humam Restaurant Menu Management</h3>
                        <hr/>
                        <form action="javascript:void(0)" @submit="register" class="row" method="post">
                            ...
                            <div class="form-group col-12 my-2">
                                ...
                                <input type="password" name="password_confirmation" v-model="user.password_confirmation" id="password_confirmation" placeholder="Confirm Password" class="form-control">
                            </div>
